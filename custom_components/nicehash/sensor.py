...
from homeassistant.const import PERCENTAGE, TEMP_CELSIUS, TEMP_FAHRENHEIT, DEVICE_CLASS_TEMPERATURE, POWER_WATT, DEVICE_CLASS_POWER
...
DEVICE_STATS_ATTRIBUTES = [
 #   {"temperature": {"unit": TEMP_CELSIUS, "device_class": DEVICE_CLASS_TEMPERATURE}},
    {"temperature": {"numerical": True, "unit": "C"}},  
    {"powerUsage": {"unit": POWER_WATT, "device_class": DEVICE_CLASS_POWER}},
    {"revolutionsPerMinutePercentage": {"unit": PERCENTAGE}},
    {"load": {"unit": PERCENTAGE}}
]
